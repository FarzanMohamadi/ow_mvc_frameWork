...
if ( $_assign_vars['dirs'] )
{
    ...
    <div class="feedback_msg error">
        شما باید امنیت نوشتن را بصورت بازگشتی در این پوشه‌ها اعمال کنید: (<a target="_blank" href="http://docs./doku.php?id=%D9%86%D8%B5%D8%A8_%D9%85%D9%88%D8%AA%D9%88%D8%B4%D8%A7%D8%A8"> <b>؟</b></a>)
    </div>
...
<div style="<?= $_assign_vars['isConfigWritable'] ? 'display: none;' : ''; ?>" >
    ...
    <textarea rows="5"  class="config" style="height: 400px;" onclick="this.select();"><?php echo $_assign_vars['configContent']; ?>
    </textarea>
</div>
...
<form method="post">
    ...
    <p style="text-align: center; color: #626262; padding-top: 19px; ">
        ...
        (
        <a style="color:#2626ef;" target="_blank" href="http://docs./doku.php?id=%D9%86%D8%B5%D8%A8_%D9%85%D9%88%D8%AA%D9%88%D8%B4%D8%A7%D8%A8"><b>؟</b>
        </a>
        )
    </p>
