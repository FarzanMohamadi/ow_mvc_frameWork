function initMP3Recorder() {
    (function (window) {
        var RECORDER_WORKER_PATH = recorderWorkerPath;
        var ENCODER_WORKER_PATH = mp3WorkerPath;
        ...
        var MP3Recorder = function (context, stream, cfg) {
            ...
            this.start = function () {
                recording = true;
                this.logStatus(OW.getLanguageText('frmaudio', 'Recording'));
            }
            this.stop = function () {
                recording = false;
                this.logStatus(OW.getLanguageText('frmaudio', 'Converting'));
            }
            ...
            this.exportMP3 = function (cb) {
                ...
                this.exportBlob(function (blob) {
                    ...
                    fileReader.addEventListener("loadend", function () {
                        ...
                        encoderWorker.postMessage({cmd: 'init',
                            config: {
                                mode: 3,
                                channels: 1,
                                samplerate: wavData.sampleRate,
                                bitrate: wavData.bitsPerSample
                            }
                        });
