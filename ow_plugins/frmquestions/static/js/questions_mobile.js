...
QUESTIONS_AddOption.prototype = {
    pop_up: function () {
        editFloatBox = OW.ajaxFloatBox('FRMQUESTIONS_MCMP_AddOptionFloatBox', [this.questionId, question_map[this.questionId].newQuestion], {
            width: '700px',
            title: OW.getLanguageText('frmquestions', 'question_add_option_inv')
        });
    }
};
...
QUESTIONS_QuestionDetails.prototype = {
    ...
    editQuestion: function (self) {
        editFloatBox = getOW().ajaxFloatBox('FRMQUESTIONS_MCMP_EditQuestion', [self.questionId], {
            width: 700,
            iconClass: 'ow_ic_add'
        })
    }
