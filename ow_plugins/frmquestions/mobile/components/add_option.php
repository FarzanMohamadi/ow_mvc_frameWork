 ...
 * Time: 1:09 PM
 */
class FRMQUESTIONS_MCMP_AddOption extends OW_Component
{
    private $uniqueId;
    private $questionId;
    ...
    public function __construct($questionId)
    {
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('frmquestions')->getMobileCmpViewDir() . 'add_option.html');
    }
    ...
    public function getJs()
    {
        return UTIL_JsGenerator::composeJsString('question_map[{$questionId}].setAddOption(new QUESTIONS_AddOption({$uniqueId},{$questionId},{$ajaxUrl}));', array(
            ...
            'ajaxUrl' => OW::getRouter()->urlForRoute('frmoption-add'),
        ));
    }
}