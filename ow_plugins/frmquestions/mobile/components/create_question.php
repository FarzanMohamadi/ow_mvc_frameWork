 ...
 * Time: 8:52 AM
 */
class FRMQUESTIONS_MCMP_CreateQuestion extends OW_MobileComponent
{
    ...
    public function __construct($context, $contextId)
    {
        ...
        $template = OW::getPluginManager()->getPlugin('frmquestions')->getMobileCmpViewDir() . 'create_question.html';
