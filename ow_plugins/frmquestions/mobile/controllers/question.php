 ...
 * Time: 11:04 AM
 */
class FRMQUESTIONS_MCTRL_Question extends OW_MobileActionController
{
    /**
     *
    ...
    public function question($params)
    {
        ...
        $cmp = new FRMQUESTIONS_MCMP_Question($question, OW::getUser()->getId(), $canUserEdit);
    ...
    public function reloadQuestion($params)
    {
        ...
        if (isset($_POST['newQuestion'])){
            $cmp = new FRMQUESTIONS_MCMP_Question(null, OW::getUser()->getId(), OW::getUser()->isAuthenticated(), $_POST['questionId'], $_POST['options']);
        }
        else{
            $question = $this->service->findQuestion($questionId);
    ...
    public function questionHome($param)
    {
        ...
        $menu = new FRMQUESTIONS_MCMP_ListMenu($type);
