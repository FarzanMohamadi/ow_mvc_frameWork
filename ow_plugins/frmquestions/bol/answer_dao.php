 ...
 * Time: 10:03 AM
 */
class FRMQUESTIONS_BOL_AnswerDao extends OW_BaseDao
{
    ...
    public function findAnswerByOptions($optionIds){
        if (empty($optionIds)) {
            return array();
        }
        $example = new OW_Example();
        $example->andFieldInArray(self::OPTION_ID, $optionIds);
        return $this->findListByExample($example);
    }
    ...
    {
        return OW_DB_PREFIX . 'frmquestions_answer';
    }

    public function getDtoClassName()
    {
        return 'FRMQUESTIONS_BOL_Answer';
    }
}