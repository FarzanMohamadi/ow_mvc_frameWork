 ...
 * Time: 1:08 PM
 */
class FRMQUESTIONS_CMP_OptionList extends OW_Component
{
    private $editMode;
    /**
    ...
    public function onBeforeRender()
    {
        ...
        foreach ($this->optionList as $option) {
            $optionCmp = new FRMQUESTIONS_CMP_Option($option, $this->userId, $this->editMode || $option->userId == $this->userId, $isMultiple, false, $this->additionalInfo);
