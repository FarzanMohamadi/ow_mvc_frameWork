 ...
 * Time: 8:57 AM
 */
class FRMQUESTIONS_CLASS_CreateQuestionForm extends Form
{
    ...
    public function __construct($ajaxUrl, $context, $contextId)
    {
        ...
        if ($context != 'groups') {
            ...
            $field->setValue(FRMQUESTIONS_BOL_Service::PRIVACY_ONLY_FOR_ME);
        ...
        $submit->setValue($language->text('frmquestions', 'question_add_save'));
