 ...
 * @since 1.0
 */
class FRMMOBILESUPPORT_BOL_AppVersionDao extends OW_BaseDao
{
    ...
    {
        return 'FRMMOBILESUPPORT_BOL_AppVersion';
    }
    
    public function getTableName()
    {
        return OW_DB_PREFIX . 'frmmobilesupport_app_version';
    }
    ...
    public function saveVersion($type, $versionName, $versionCode, $url, $message){
        ...
        $version = new FRMMOBILESUPPORT_BOL_AppVersion();
        $version->type = $type;
