 ...
 * @package ow.ow_plugins.frmnews
 * @since 1.7.2
 */
class FRMNEWS_CLASS_ContentProvider
{
     ...
     * Singleton instance.
     *
     * @var FRMNEWS_CLASS_ContentProvider
     */
     ...
     *
     * @return FRMNEWS_CLASS_ContentProvider
     */
    ...
    public function onCollectTypes( BASE_CLASS_EventCollector $event )
    {
        $event->add(array(
            "pluginKey" => "frmnews",
            "group" => "frmnews",
            "groupLabel" => OW::getLanguage()->text("frmnews", "content_news_label"),
            "entityType" => self::ENTITY_TYPE,
            "entityLabel" => OW::getLanguage()->text("frmnews", "content_news_label"),
    ...
    public function onAfterEntryEdit( OW_Event $event )
    {
        ...
        OW::getEventManager()->trigger(new OW_Event(BOL_ContentService::EVENT_AFTER_CHANGE, array(
            ...
            "string" => array("key" => "frmnews+feed_edit_item_label")
        )));
    }
