 ...
 * @since 1.0
 */
class FRMNEWS_CTRL_News extends OW_ActionController
{
    ...
    public function index($params)
    {
        ...
        {
            $this->assign('my_published_entrys_url', OW::getRouter()->urlForRoute('frmnews-manage-entrys'));
        }
        ...
        $tagSearch = new BASE_CMP_TagSearch(OW::getRouter()->urlForRoute('frmnews.list',
            array('list'=>'browse-by-tag')),'base+tag_search','tag' ,true,
            'news-entry', OW::getRouter()->urlForRoute('frmnews.list', array('list'=>'browse-by-tag')), $tagCount);
        $this->addComponent('tagSearch', $tagSearch);

        $entrySearch = new BASE_CMP_TagSearch(OW::getRouter()->urlForRoute('frmnews.list', array('list'=>'search-results')),
            'frmnews+search_entries','q');
        ...
        $this->setDocumentKey("news_index");
    }
