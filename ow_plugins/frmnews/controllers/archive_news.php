 ...
 * @since 1.0
 */
class FRMNEWS_CTRL_ArchiveNews extends OW_ActionController
{
    ...
    public function index( $params )
    {
        ...
        */
        ...
        if ( !empty($_GET['month']) )
        {
            ...
            OW::getDocument()->setTitle(OW::getLanguage()->text('frmnews', 'archive_news_archive_title', array('year'=>$yearTitle,'month_name'=>$monthTitle)));
            OW::getDocument()->setDescription(OW::getLanguage()->text('frmnews', 'archive_news_archive_description', array('year'=>$yearTitle, 'month_name'=>$monthTitle) ));
        }
        else
        {
            ...
            OW::getDocument()->setTitle(OW::getLanguage()->text('frmnews', 'archive_news_title'));
            OW::getDocument()->setDescription(OW::getLanguage()->text('frmnews', 'archive_news_description' ));
        }
