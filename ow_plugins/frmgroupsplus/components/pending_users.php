 ...
 * @package ow_plugins.frmgroupsplus.classes
 * @since 1.0
 */
class FRMGROUPSPLUS_CMP_PendingUsers extends OW_Component
{
    /**
     * FRMGROUPSPLUS_CMP_PendingUsers constructor.
     * @param null|string $groupIdinfo
     * @param $count
     */
    public function __construct($groupId, $count = 0)
    {
        ...
        $revokeUrl = OW::getRouter()->urlFor('FRMGROUPSPLUS_CTRL_Groups', 'revoke');
        ...
        $this->assign('ShowPendingAllUsersUrl', "OW.ajaxFloatBox('FRMGROUPSPLUS_CMP_PendingUsers', {groupId: '".$groupId."', count:-1} , {width:700, iconClass: 'ow_ic_add'});");
    }
}