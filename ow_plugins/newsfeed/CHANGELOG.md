...
# Version 2 (10769)
- fix bug in notification message of dislike a user or group status

# Version 2 (10768)
- fix bug in web service message of dislike a user or group status 

# Version 2 (10767)
- fix bug in view channel 

# Version 2 (10766)
- fix bug in notification of groupRSS

# Version 2 (10765)
- remove group description from load-item-list request

# Version 2 (10764)
- solve problem of showing liked users after disabling dislike and comment

# Version 2 (10763)
- remove group description from load-item request

# Version 2 (10760)
- add dislike functionality to newsfeed posts

# Version 2 (10759)
- add dislike functionality to newsfeed posts (reverted)

# Version 2 (10758)
- add dislike functionality to newsfeed posts (frmlike component)
...
# Version 1.8.4 (10666)
- fixed problem with load more function in the mobile version

# Version 1.8.4 (10665)
- fixed minor problem with prefetch rendering in the mobile version

# Version 1.8.4 (10664)
- remove delete user button from menu of a newsfeed
- fixed errors for of the request security manager

# Version 1.8.4 (10662)
- make it possible to upload multiple photos in mobile version of newsfeed

# Version 1.8.4 (10661)
- fixed like string not showing with ajax in mobile version
...
# Version 1.8.4 (10658)
- fix debug notice in channels in mobile version

# Version 1.8.4 (10657)
- hide group join feed in channels
