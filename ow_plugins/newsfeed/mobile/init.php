...
OW::getEventManager()->bind("mobile.content.dashboard", array($eventHandler, "onDashboardBottomContentCollect"));
...
OW::getEventManager()->bind('feed.on_item_render', array($eventHandler, 'mobileItemRender'));
