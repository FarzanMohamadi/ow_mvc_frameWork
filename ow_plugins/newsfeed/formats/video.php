...
class NEWSFEED_FORMAT_Video extends NEWSFEED_CLASS_Format
{
    ...
    public function __construct($vars, $formatName = null) 
    {
        ...
        $this->uniqId = FRMSecurityProvider::generateUniqueId("vf-");
    ...
    protected function initJs()
    {
        ...
        OW::getEventManager()->trigger(new OW_Event(FRMEventManager::ON_AFTER_VIDEO_RENDERED, array('uniqId' =>$this->uniqId )));
    }
