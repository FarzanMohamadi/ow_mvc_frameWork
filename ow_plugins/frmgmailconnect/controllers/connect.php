<?php
class FRMGMAILCONNECT_CTRL_Connect extends OW_ActionController
{
    /**
     *
    ...
    public function oauth()
    {
     ...
     if ($result) {
         echo "<script>window.opener.OW.message('" . $language->text('frmgmailconnect', 'login_success_msg') . "','info');" .
