 ...
 * @since 1.0
 */
class FRMHASHTAG_CMP_Photo extends OW_Component
{
    ...
    public function __construct($tag, $allCount)
    {
        ...
        $photoDefault = array(
            'getPhotoURL' => OW::getRouter()->urlFor('FRMHASHTAG_CTRL_Load', 'ajaxResponder', array('tag' => $tag)),
        ...
        $idList = FRMHASHTAG_BOL_Service::getInstance()->findEntitiesByTag($tag,"photo_comments");
