# Version 2 (10853)
- Bug fix in user search page

# Version 2 (10853)
- Bug fix in Oghat widget

# Version 2 (10852)
- add pending users list component to groups menu, in mobile version

# Version 2 (10849)
- fix select2 bugs

# Version 2 (10848)
- add select2 configurations

# Version 2 (10847)
- fixed some graphical problems in widgets open/close arrow place
...
# Version 2 (10844)
- fixed graphics for English version

# Version 1.8.4 (10843)
- fixed graphical bug in open/close widgets icon

# Version 1.8.4 (10840)
-adding the possibility to hide the rating widget from guest users

# Version 1.8.4 (10839)
-fixed the arrow of closing widgets' position bug
