<?php
class FRMPHOTOPLUS_CTRL_AjaxUpload extends OW_ActionController
{
    ...
    public function ajaxSubmitPhotos( $params )
    {
        ...
        $form = new FRMPHOTOPLUS_CLASS_AjaxUploadForm('user', $userId);
       ...
       // FRMPHOTOPLUS_BOL_Service::getInstance()->addStatusPhoto($information,$_POST['infoId'],$userId,time());
