<?php
class FRMPHOTOPLUS_BOL_StatusPhotoDao extends OW_BaseDao
{
    ...
    {
        return 'FRMPHOTOPLUS_BOL_StatusPhoto';
    }

    public function getTableName()
    {
        return OW_DB_PREFIX . 'frmphotoplus_status_photo';
    }
    ...
    public function addStatusPhoto($photoId, $userId)
    {
        ...
        $statusPhoto = new FRMPHOTOPLUS_BOL_StatusPhoto();
