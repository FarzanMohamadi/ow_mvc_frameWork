<?php
class FRMPROFILEMANAGEMENT_BOL_Service
{
    ...
    {
        $jsDir = OW::getPluginManager()->getPlugin('frmprofilemanagement')->getStaticJsUrl();
        OW::getDocument()->addScript($jsDir.'frmprofilemanagement.js');
    }

    public function onBeforeProfileEditRenderJsFunction(){
        OW::getDocument()->addStyleSheet(OW::getPluginManager()->getPlugin('frmprofilemanagement')->getStaticCssUrl().'frmprofilemanagement.css');
        $jsDir = OW::getPluginManager()->getPlugin('frmprofilemanagement')->getStaticJsUrl();
