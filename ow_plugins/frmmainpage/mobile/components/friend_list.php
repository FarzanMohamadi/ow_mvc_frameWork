 ...
 * @since 1.0
 */
class FRMMAINPAGE_MCMP_FriendList extends OW_MobileComponent
{
    ...
    public function __construct($listKey, $list, $showOnline)
    {
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('frmmainpage')->getMobileCmpViewDir().'friend_list.html');
    }
