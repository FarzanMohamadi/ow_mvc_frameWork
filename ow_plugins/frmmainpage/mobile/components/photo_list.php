<?php
class FRMMAINPAGE_MCMP_PhotoList extends OW_MobileComponent
{
    ...
    public function __construct( $listType, $photos )
    {
        ...
        $this->list = $photos;
        $this->setTemplate(OW::getPluginManager()->getPlugin('frmmainpage')->getMobileCmpViewDir().'photo_list.html');
