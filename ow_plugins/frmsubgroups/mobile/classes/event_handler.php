 ...
 * @since 1.0
 */
class FRMSUBGROUPS_MCLASS_EventHandler
{
    ...
    public function init()
    {
        ...
        $eventManager->bind('frmgroupsplus.add.file.widget', array($service, 'addSubGroupWidget'));
        ...
        $eventManager->bind('groups_find_parent', array($service, 'onFindParentGroup'));
    }
