...
class FRMNEWSFEEDPLUS_CLASS_EventHandler
{
    ...
    public function init()
    {
        ...
        $eventManager->bind('on.feed.item.add.role.data', array($service, 'onFeedItemAddRoleData'));
        $eventManager->bind('newsfeed_defualt_link_icon_renderer', array($service, 'newsfeedDefualtLinkIconRenderer'));
