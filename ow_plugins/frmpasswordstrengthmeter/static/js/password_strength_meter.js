...
function comparePasswordAndrepeatPassword(password,repeatPassword)
{
    ...
    {
        strengthDivPlace.innerHTML = OW.getLanguageText('frmpasswordstrengthmeter', 'password_repeatpassword_compare_error');
...
function validatePasswordStrength(password, minimumCharacter,minimumRequirementPasswordStrength){
    ...
    state['poor_label'] = OW.getLanguageText('frmpasswordstrengthmeter', 'strength_poor_label');
    ...
    state['weak_label'] = OW.getLanguageText('frmpasswordstrengthmeter', 'strength_weak_label');
    ...
    state['good_label'] = OW.getLanguageText('frmpasswordstrengthmeter', 'strength_good_label');
    ...
    state['excellent_label'] = OW.getLanguageText('frmpasswordstrengthmeter', 'strength_excellent_label');
    ...
    var htmlCode = '<div class="password_strength_meter_parent" id="'+$password_strength_meter_id+'">' +
        ...
        '<tr>' +
        '<td colspan="5"><span id="secure_password_minimum_strength_type">'+OW.getLanguageText("frmpasswordstrengthmeter", "secure_password_information_minimum_strength_type",{'value':minimumRequirementPasswordStrength})+'</span></td>' +
        '</tr>' +
        '<tr>' +
        '<td colspan="5"><a href="javascript:secure_password_information()" id="secure_password_information">'+OW.getLanguageText("frmpasswordstrengthmeter", "secure_password_information_title")+'</a></td>' +
        '</tr>' +
        '</table>' +
        '</div>';
...
function secure_password_information(){
    OW.ajaxFloatBox('FRMPASSWORDSTRENGTHMETER_CMP_Securepassword', {} , {width:480, iconClass: 'ow_ic_add', title: OW.getLanguageText('frmpasswordstrengthmeter', 'secure_password_information_title')});
}