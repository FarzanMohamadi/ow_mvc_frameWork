...
class EVENT_CTRL_Base extends OW_ActionController
{
    ...
    public function add()
    {
        ...
        $this->setDocumentKey("user_event_add");
    }
    ...
    public function view( $params )
    {
        ...
        if(isset($resultsEvent->getData()['categoryLabel'])) {
            ...
            $resultsEvent = OW::getEventManager()->trigger(new OW_Event(FRMEventManager::ADD_EVENT_FILTER_FORM, array('tab' => self::$EVENT_GENERAL, 'categoryStatus' => $resultsEvent->getData()['categoryId'])));
        ...
        $this->setDocumentKey("event_view");
    }
    ...
    {
        $this->setDocumentKey("user_events");
        $language = OW::getLanguage();
        $this->setPageHeading($language->text('event',  'auth_group_label'));
        $this->setPageTitle($language->text('event',  'auth_group_label'));
        ...
        switch ( trim($params['list']) )
        {
            ...
            default:
                if (trim($params['list']) == "event_general")
                    $this->setDocumentKey("latest_events user_events");
