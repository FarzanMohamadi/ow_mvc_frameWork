 ...
 * @since 1.0
 */
class FRMMENTION_CLASS_EventHandler
{
    ...
    public function genericInit()
    {
        ...
        OW::getEventManager()->bind(FRMEventManager::ON_BEFORE_RENDER_STRING, array($service,'renderString')); //newsfeed, groups, event, video, forum
        ...
        OW::getEventManager()->bind('notifications.on_duplicate', array($service, 'onNotificationDuplicate'));
    ...
    public function onBeforeDocumentRender( OW_Event $event )
    {
        ...
        // {
            ...
            OW::getDocument()->addScript( OW::getPluginManager()->getPlugin('frmmention')->getStaticJsUrl() . 'frmmention.js' );
        // }
    }
}