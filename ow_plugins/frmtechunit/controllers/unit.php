...
class FRMTECHUNIT_CTRL_Unit extends OW_ActionController
{
    const COUNT = 10;
    ...
    public function addUnit($params)
    {
        ...
        foreach ($orderedList as $item) {
            ...
            $field = new WysiwygTextarea($section->name,'frmtechunit',$buttons);
    ...
    public function unit($params)
    {
        ...
        $unitCmp = new FRMTECHUNIT_CMP_Unit($unit);
