 ...
 * @since 1.0
 */
class FRMCFP_BOL_EventUserDao extends OW_BaseDao
{
     ...
     *
     * @return FRMCFP_BOL_EventUserDao
     */
    ...
    {
        return OW_DB_PREFIX . 'frmcfp_user';
    }
    ...
    public function findListByEventIdAndStatus( $eventId, $status, $first, $count )
    {
        $queryParts = BOL_UserDao::getInstance()->getUserQueryFilter("e", "userId", array(
            "method" => "FRMCFP_BOL_EventUserDao::findListByEventIdAndStatus"
        ));
    ...
    {
        $queryParts = BOL_UserDao::getInstance()->getUserQueryFilter("e", "userId", array(
            "method" => "FRMCFP_BOL_EventUserDao::findListByEventId"
        ));
    ...
    {
        $queryParts = BOL_UserDao::getInstance()->getUserQueryFilter("e", "userId", array(
            "method" => "FRMCFP_BOL_EventUserDao::findUsersCountByEventIdAndStatus"
        ));
