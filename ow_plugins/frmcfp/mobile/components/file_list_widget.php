 ...
 * @since 1.0
 */
class FRMCFP_MCMP_FileListWidget extends BASE_CLASS_Widget
{

    /**
     * FRMCFP_MCMP_FileListWidget constructor.
...
//        if ( $eventDto->userId==OW::getUser()->getId())
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('frmcfp')->getMobileCmpViewDir() . 'file_list_widget.html');
    }
