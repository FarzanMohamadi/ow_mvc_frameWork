<?php
/**
 * Data Access Object for `frmeventplus_event_files` table.
 *
 * @author Farzan Mohammadi <farzan.mohamadii@gmail.com>
 * @package ow_plugins.frmeventplus.bol
 * @since 1.0
 */
class FRMEVENTPLUS_BOL_EventFilesDao extends OW_BaseDao
{
     ...
     * Singleton instance.
     *
     * @var FRMEVENTPLUS_BOL_EventFilesDao
     */
     ...
     *
     * @return FRMEVENTPLUS_BOL_EventFilesDao
     */
    ...
    {
        return 'FRMEVENTPLUS_BOL_EventFiles';
    }
    ...
    {
        return OW_DB_PREFIX . 'frmeventplus_event_files';
    }
    ...
    {
        $eventFiles = new FRMEVENTPLUS_BOL_EventFiles();
