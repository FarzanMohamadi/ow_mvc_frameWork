<?php
class FRMEVENTPLUS_MCMP_FileListWidget extends BASE_CLASS_Widget
{

    /**
     * FRMEVENTPLUS_MCMP_FileListWidget constructor.
    ...
    public function __construct( BASE_CLASS_WidgetParameter $params )
    {
        ...
        $this->assign('view_all_files', OW::getRouter()->urlForRoute('frmeventplus.file-list', array('eventId' => $eventId)));
        $this->setTemplate(OW::getPluginManager()->getPlugin('frmeventplus')->getMobileCmpViewDir() . 'file_list_widget.html');
    }

    private function assignList( $eventId, $count,$canEdit )
    {
        $list = FRMEVENTPLUS_BOL_Service::getInstance()->findFileList($eventId, 0, $count);
    ...
    public static function getSettingList()
    {
        ...
        $settingList['count'] = array(
            ...
            'label' => OW_Language::getInstance()->text('frmeventplus', 'widget_files_settings_count'),
            'value' => 10
        );
    ...
    public static function getStandardSettingValueList()
    {
        return array(
            ...
            self::SETTING_TITLE => OW_Language::getInstance()->text('frmeventplus', 'widget_files_title'),
