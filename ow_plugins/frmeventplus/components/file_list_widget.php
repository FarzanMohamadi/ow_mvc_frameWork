<?php
class FRMEVENTPLUS_CMP_FileListWidget extends BASE_CLASS_Widget
{

    /***
     * FRMEVENTPLUS_CMP_FileListWidget constructor.
    ...
    private function assignList( $eventId, $count,$canEdit )
    {
        ...
        $this->assign("filesCount", FRMEVENTPLUS_BOL_Service::getInstance()->findFileListCount($eventId));
