 ...
 * @since 1.0
 */
class FRMEMOJI_MCLASS_EventHandler
{
    ...
    public function onBeforeDocumentRender(OW_Event $event)
    {
        ...
        $bg_photo_addr = OW::getPluginManager()->getPlugin('frmemoji')->getStaticCssUrl() . 'sheet_' . $emojiType . '_64_indexed_128.png';
