...
try
{
    ...
    FRMSecurityProvider::deleteWidgetUsingComponentPlaceUniqueName("admin-5295f2e03ec8a");

    //Remove default widget in mobile
    FRMSecurityProvider::deleteWidgetUsingComponentPlaceUniqueName("admin-5295f2e40db5c");
