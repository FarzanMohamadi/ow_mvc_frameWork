var ThemesSelect = function(themeList, addData)
{
    ...
    $.each(themeList, function() {
        ...
        function(e) {
            ...
            $('html body .ow_admin_choose_theme .selected_theme_info').css('display','block');
            $('.selected_theme_info.frm_theme_manager_themes').css('display','none');
            ...
            $('.theme_version', $context).empty().append(e.data.data.build);
