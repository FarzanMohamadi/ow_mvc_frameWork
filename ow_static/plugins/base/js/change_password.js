var OW_ChangePassword = function($params)
{
        ...
        var password = $("#" + this.formName + " input[name='" + this.elementName + "']");
        ...
        {
            var element = owForms[this.formName].elements[this.elementName];
           ...
           //var data = $.httpData( xhr, 'json');
            ...
            {
                 var text = OW.getLanguageText('base', 'password_protection_error_message');
