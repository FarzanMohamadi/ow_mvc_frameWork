...
final class BOL_TextFormatService
{
    ...
    private function __construct()
    {
        $this->buttonTags = array(
            ...
            self::WS_BTN_TABLE => array('tags' => array('table', 'tbody', 'th', 'tr', 'td'), 'attrs' => array('table.width', 'table.height', 'table.border', 'table.style')),
        );
...
//        $text = str_replace(array('<div>', '</div>'), array('', '<br />'), $text);
        ...
        // default attrs list
        $attrsArray = array('class', 'p.style', 'style', 'dir');
        ...
        $attrsArray = array_unique($attrsArray);
