...
class ADMIN_CLASS_SeoSitemapForm extends Form
{
    ...
    public function __construct()
    {
        ...
        $userFilesIndexing = new CheckboxField('userFilesIndexing');
        $userFilesIndexing->setValue(OW::getConfig()->getValue('base', 'seo_sitemap_user_files_indexing'));
        $userFilesIndexing->setLabel(OW::getLanguage()->text('admin', 'seo_sitemap_user_files_indexing'));
        $userFilesIndexing->setDescription(OW::getLanguage()->text('admin', 'seo_sitemap_user_files_indexing_desc'));
        $this->addElement($userFilesIndexing);
