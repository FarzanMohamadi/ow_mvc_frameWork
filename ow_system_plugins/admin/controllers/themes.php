...
class ADMIN_CTRL_Themes extends ADMIN_CTRL_StorageAbstract
{
    ...
    public function chooseTheme()
    {
        ...
        if ( (isset($customThemeEvent->getData()['isPluginActive'] ) && $customThemeEvent->getData()['isPluginActive'] === true) ){
            $frmThemeManagerThemes = $customThemeEvent->getData();
            $this->addComponent('frmThemeManagerThemesListCMP', new FRMTHEMEMANAGER_CMP_ThemeList(array('key'=>'appearance')));
            $this->addComponent('frmThemeManagerThemesViewCMP', new FRMTHEMEMANAGER_CMP_ThemeView());
